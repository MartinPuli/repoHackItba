      ...
      <div className="mt-8 grid gap-6 lg:grid-cols-3">
        <div className="glass-card p-6 lg:col-span-2">
          ...
          <div className="flex flex-wrap gap-2">
            <PrimaryButton>Depositar desde Wallet</PrimaryButton>
            <PrimaryButton variant="outline">Retirar a Wallet</PrimaryButton>
          </div>
        </div>
        ...
        <div className="glass-card flex flex-col p-6">
          ...
          <PrimaryButton variant="ghost" className="mt-4 gap-2 self-start">
